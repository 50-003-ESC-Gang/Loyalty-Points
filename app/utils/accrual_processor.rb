class AccrualProcessor
    ...
    @@current_index=1
    def convert_to_accrual(transaction)
        time = Time.new()
        ...
        company_code = transaction.loyalty_program_id
        ...
        accrual_file.syswrite("#{current_index},#{transaction.loyalty_program_data_id.account_id},#{transaction.loyalty_program_data_id.account_id.user_id.name},#{transaction.loyalty_program_data_id.account_id.user_id.lastname},
